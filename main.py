...
def array_merge(firstArray, secondArray):
    if isinstance(firstArray, list) and isinstance(secondArray, list):
        return firstArray + secondArray
    elif isinstance(firstArray, dict) and isinstance(secondArray, dict):
        return dict(list(firstArray.items()) + list(secondArray.items()))
    elif isinstance(firstArray, set) and isinstance(secondArray, set):
        return firstArray.union(secondArray)
    return False
